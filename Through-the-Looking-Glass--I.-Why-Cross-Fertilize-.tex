...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, coltitle=black, opacityback=0, toprule=.15mm, breakable, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, bottomrule=.15mm, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, coltitle=black, opacityback=0, toprule=.15mm, breakable, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2.1. Levene's model of multiple niche polymorphism.}, bottomrule=.15mm, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, coltitle=black, opacityback=0, toprule=.15mm, breakable, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 3.1.}, bottomrule=.15mm, arc=.35mm, leftrule=.75mm]
...
\emph{Microphallus}]{\label{fig-4.1}Left panel: the life cycle of the
trematode \emph{Microphallus}. The adult worms live in the intestines of
waterfowl and wading birds (black stilts). They produce cross-fertilized
eggs, which are released into lakes and streams with the bird's feces.
The eggs hatch following ingestion by snails. Infection results in the

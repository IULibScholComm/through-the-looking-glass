...
\sidecaption[Clonal invasion dynamics]{\label{fig-1.2}Clonal invasion
...
{\centering \includegraphics{images/fig1-3_hr.png}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Box 1.1}, toptitle=1mm, colback=white, opacitybacktitle=0.6, left=2mm, toprule=.15mm, bottomtitle=1mm, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, titlerule=0mm, coltitle=black, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, toptitle=1mm, colback=white, opacitybacktitle=0.6, left=2mm, toprule=.15mm, bottomtitle=1mm, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, rightrule=.15mm, titlerule=0mm, coltitle=black, opacityback=0]
...
heterozygote advantage (\protect\hyperlink{callout-2.1}{Box 2.1}). This
was also one of the first models to fuse population genetics with
ecology. But how does multiple niche polymorphism apply to sex? The idea
is that if selection results in polymorphism, then a genetically diverse
sexual population might be resistant to replacement by a clonal lineage
that specializes on only one of the available resource types (as also in
...
{\centering \includegraphics{images/fig2-2_hr.png}
...
{\centering \includegraphics{images/fig2-3_hr.png}
...
{\centering \includegraphics{images/fig2-4_hr.png}
...
\hypertarget{appendix-a-levenes-model-of-multiple-niche-polymorphism}{%
\section{Appendix A: Levene's model of multiple niche
polymorphism}\label{appendix-a-levenes-model-of-multiple-niche-polymorphism}}
...
\sidecaption[Prout's model of dominance]{\(\mathrm{\Delta}q\) as a
function of \(q\) for Prout's model of dominance}
...
more resistant to attack by this predator (1986c).\footnote{Dieter Ebert
  showed that parasites of \emph{Daphnia} were locally adapted for both
  infectivity and transmission, which was a major advance.} Hence, the
...
and sex.\footnote{In direct contrast, however, Oka found that
  cross-fertilization did not occur between \emph{Botryllus} gametes
  that shared the same allele. As Oka noted, this result mirrors the
  S-allele system in plants: ``The \ldots{} situation corresponds
  exactly in its form to the homomorphic self-incompatibility prevailing
  among angiosperms.''} These topics were also very interesting to Wally
Clark, a conceptual pioneer in the evolution of plasticity. He was also
head of the Zoology Department at the University of Canterbury. I would
not have received funding without the support of Prof.~Clark. To my
mind, the value of Clark's work remains underestimated in general, but
...
{\centering \includegraphics{images/fig3-5_hr.png}
...
{\centering \includegraphics{images/fig3-6_hr.png}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 3.1}, toptitle=1mm, colback=white, opacitybacktitle=0.6, left=2mm, toprule=.15mm, bottomtitle=1mm, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, rightrule=.15mm, titlerule=0mm, coltitle=black, opacityback=0]
...
{\centering \includegraphics{images/fig3-7_hr.png}
...
\hypertarget{self--non-self-recognition-and-local-adaptation}{%
...
(Figure~\ref{fig-4.2}). In other words, the \emph{Microphallus}
parasites were locally adapted (Lively 1989). There was no reason based
on this experiment to discard the Red Queen.

\begin{figure}

\sidecaption[Results of the first reciprocal cross-inoculation
experiment]{\label{fig-4.2}Results of the first reciprocal
cross-inoculation experiment. The vertical bars show one SE of the mean.
Redrawn from Lively (1989).}

{\centering \includegraphics{images/fig4-4.png}
...
not matter to the strength of local adaptation (Figure~\ref{fig-4.3}).
...
\sidecaption[Results of the second reciprocal cross-inoculation
experiment]{\label{fig-4.3}Results of the second reciprocal
cross-inoculation experiment. Vertical bars show one SE of the mean.
Redrawn from Lively (1989).}

{\centering \includegraphics{images/fig4-5.png}
...
\sidecaption[Results from a meta-analysis of local adaption
experiments]{\label{fig-4.4}Results from a meta-analysis of local
...
{\centering \includegraphics{images/fig4-6.png}

}

\end{figure}

\hypertarget{self--non-self-recognition}{%
\section{Self- /
Non-Self-Recognition}\label{self--non-self-recognition}}
...
locus (Figure~\ref{fig-4.5}): ``To summarize Oka's work, it is
...
\sidecaption[A model for self- / non-self-recognition]{\label{fig-4.5}A
...
{\centering \includegraphics{images/fig4-7.jpeg}
...
\leavevmode\vadjust pre{\hypertarget{ref-bancroft1903a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-burnet1971a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-ebert1994a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-hamilton1980a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-lively1989a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-lively2004a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-lively2022a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-moore1984a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-oka1970a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-parker1985a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-smith2003a}{}}%
Smith, S. (n.d.).

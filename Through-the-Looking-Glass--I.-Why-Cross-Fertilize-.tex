...
\section*{How to Use (HTML Book)}\label{how-to-use-html-book}
\addcontentsline{toc}{section}{How to Use (HTML Book)}

\markright{How to Use (HTML Book)}

\begin{itemize}
\tightlist
\item
  \textbf{How to Access this Book in Formats other than HTML}

  \begin{itemize}
  \tightlist
  \item
    \textbf{EPUB:} click in the lefthand sidebar or click
    \href{https://iulibscholcomm.github.io/through-the-looking-glass/Through-the-Looking-Glass--I.-Why-Cross-Fertilize-.epub}{here}

    \begin{itemize}
    \tightlist
    \item
      Good for eReaders, accessibility by the disabled, and reflowable
      text
    \end{itemize}
  \item
    \textbf{PDF:} click in the lefthand sidebar or click
    ...
    \end{itemize}
  \item
    \textbf{DOCX:} click in the lefthand sidebar or click
    \href{https://iulibscholcomm.github.io/through-the-looking-glass/Through-the-Looking-Glass--I.-Why-Cross-Fertilize-.docx}{here}

    \begin{itemize}
    \tightlist
    \item
      The Microsoft Word version is good for human-readable reuse,
      remixing, etc.
    \end{itemize}
  \item
    \textbf{Quarto Markdown:} click `` View source'' in the righthand
    sidebar
...
\item
  ...
  \tightlist
  \item
    Click in the lefthand sidebar and select Twitter (now X), Facebook,
    or LinkedIn.
  \end{itemize}
\item
  ...
  \tightlist
  \item
    Click ``Report an Issue'' in the righthand sidebar, then complete
    and submit the bug report
  \end{itemize}
\end{itemize}

To learn more about this book and how to use it, see
...
disease (review in \citeproc{ref-lehtonen2012a}{Lehtonen \emph{et al.}
2012}). However, while important, these costs do not form the core of
...
(\citeproc{ref-moore1984a}{1984}). Soon, universities began to advertise
...
controlled by nematode infections (\citeproc{ref-hudson1998a}{1998}).

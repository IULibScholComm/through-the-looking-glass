...
offspring.\footnote{Paternal leakage of DNA in otherwise asexual
  ...
  2010).} (See Chapter~\ref{sec-glossary} for condensed definitions.)
...
value.\footnote{In a follow up study, using independent samples, Steve
  Weeks (one of Vrijenhoek's PhD students) was unable to replicate some
  of our results (Weeks 1996). However, his sample sizes were very low,
  especially for clonal fish, suggesting that his power to detect
  differences was compromised.} His model only assumes that sexual and
asexual females have equal fecundities and survivorship probabilities
(see Section~\ref{sec-app-1}). Under this assumption, a very rare clone
...
recombination.''\footnote{It is important to point out that we were not
  claiming that parasite-mediated selection is maintaining sex in this
  system. For example, we wrote, ``{[}w{]}e do not intend to imply from
  this analysis that the trematode is selecting for the maintenance of
  sex in these fish.'' Niche partitioning and/or the sperm-dependence of
  the gynogenetic females would most likely ensure the persistence of
  sexual individuals (Moore \& McKay 1971; Schenck \& Vrijenhoek 1986).
  Our claim was simply that parasites had evolved to disproportionately
  infect the most common clone unless the sexual population was highly
  inbred.} Hence, there are two interrelated anomalies:
...
producing males.\footnote{With respect to \emph{Potamopyrgus} (along
  with a parthenogenetic beetle) Maynard Smith (1978) wrote, ``Further
  ...
  But I think that he was correct.} Let \(N_{asex}\) be the number of
asexual females at time one, while \(N_{sex}\) gives the total number of
sexual individuals (males plus females) at time one. Let \(B_{asex}\)
...
\textbf{Variance}\footnote{In a follow up study, using independent
  samples, Steve Weeks (one of Vrijenhoek's PhD students) was unable to
  replicate some of our results (Weeks 1996). However, his sample sizes
  were very low, especially for clonal fish, suggesting that his power
  to detect differences was compromised.} & 19400 & 600 \\
\textbf{Geometric mean (GM)}\footnote{It is important to point out that
  we were not claiming that parasite-mediated selection is maintaining
  sex in this system. For example, we wrote, ``{[}w{]}e do not intend to
  imply from this analysis that the trematode is selecting for the
  maintenance of sex in these fish.'' Niche partitioning and/or the
  sperm-dependence of the gynogenetic females would most likely ensure
  the persistence of sexual individuals (Moore \& McKay 1971; Schenck \&
  Vrijenhoek 1986). Our claim was simply that parasites had evolved to
  disproportionately infect the most common clone unless the sexual
  population was highly inbred.} & 184 & \textbf{219} \\
...
attack by this predator (1986c).\footnote{In a follow up study, using
  independent samples, Steve Weeks (one of Vrijenhoek's PhD students)
  was unable to replicate some of our results (Weeks 1996). However, his
  sample sizes were very low, especially for clonal fish, suggesting
  that his power to detect differences was compromised.} Hence, the two
...
developmental plasticity and sex.\footnote{It is important to point out
  that we were not claiming that parasite-mediated selection is
  maintaining sex in this system. For example, we wrote, ``{[}w{]}e do
  not intend to imply from this analysis that the trematode is selecting
  for the maintenance of sex in these fish.'' Niche partitioning and/or
  the sperm-dependence of the gynogenetic females would most likely
  ensure the persistence of sexual individuals (Moore \& McKay 1971;
  Schenck \& Vrijenhoek 1986). Our claim was simply that parasites had
  evolved to disproportionately infect the most common clone unless the
  sexual population was highly inbred.} These topics were also very
...
interesting, whether or not it could explain sex.\footnote{In a follow
  up study, using independent samples, Steve Weeks (one of Vrijenhoek's
  PhD students) was unable to replicate some of our results (Weeks
  1996). However, his sample sizes were very low, especially for clonal
  fish, suggesting that his power to detect differences was compromised.}
In addition, May and Anderson (1983) had already ignited a general
interest in parasites. They showed that, contrary to conventional
wisdom, parasites would evolve to maximize their own rates of
transmission without any ``consideration'' for the well-being of their
hosts. This work, combined with Hamilton and Zuk's model of
parasite-mediated mate choice, along with Hamilton's models on
...
locus.\footnote{It is important to point out that we were not claiming
  ...
  infect the most common clone unless the sexual population was highly
  inbred.} To my mind, this was a major finding.
...
2.\footnote{In a follow up study, using independent samples, Steve Weeks
  (one of Vrijenhoek's PhD students) was unable to replicate some of our
  results (Weeks 1996). However, his sample sizes were very low,
  especially for clonal fish, suggesting that his power to detect
  differences was compromised.} This seemed very promising for the Red
Queen.
...
1, and it was also more infected than clone 1 (Fig. 5.2). However, clone
1 was not more infected than the sexual form of P. monacha, which showed
that clone 1 is not inherently more susceptible to infection (Lively et
al.~1990). Taken together, the results suggest that the parasites had
evolved to disproportionately attack the most common local clone.
...
very lucky to have had the opportunity to work with Prof.~Vrijenhoek.
...
species complexes of poeciliopsis (pisces: poeciliidae). \emph{Ecology},
52, 791--799.

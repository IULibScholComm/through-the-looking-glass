...
Figure~\ref{fig-3-5}.\footnote{I will write much more about Jukka's many
  contributions in the next volume.} We then resampled all 20 lakes 10
-- 15 years after my original samples (with greater coverage of the
lakes and larger sample sizes). We found that prevalence of infection
within lakes was highly correlated between sample periods. This result
suggests that lakes for which parasite-mediated selection was relatively
high during the first set of samples was also relatively high in the
second set of samples. In addition, male frequency within lakes was also
highly correlated between sample periods

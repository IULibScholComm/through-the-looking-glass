...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, colback=white, opacityback=0, toptitle=1mm, titlerule=0mm, rightrule=.15mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomtitle=1mm, opacitybacktitle=0.6, bottomrule=.15mm, toprule=.15mm, left=2mm, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, colback=white, opacityback=0, toptitle=1mm, titlerule=0mm, rightrule=.15mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 3.1}, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomtitle=1mm, opacitybacktitle=0.6, bottomrule=.15mm, toprule=.15mm, left=2mm, breakable]

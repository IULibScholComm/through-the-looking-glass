...
::: {#fig-1-2}
[![](images/fig1-2.jpg)]{fig-alt="two visualizations of frequncy of daughters by females"}
...
![Two flower morphs (distyly) in *Primula*.  Darwin found that the short-styled morph (left) is incompatible with other short-style morphs, and that the long styled morph (right) is incompatible with other long-style morphs.  But the two different morphs can cross-fertilize.  The arrows show movement of pollen from anthers to stigmas.  The “X” indicates incompatibility.  Redrawn from Darwin [-@darwin1862a] by ZMD.](images/fig1-3.jpg){#fig-1.3 fig-alt="Two flower morphs (distyly) in *Primula*" width=125%}

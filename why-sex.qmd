...
Over 100 years later, W. D. Hamilton (1975) was also pondering the evolution of outcrossing, and he wrote something conceptually similar: "...complete inbreeding abandons the obviously important advantages of sexual reproduction, whatever these are.""
...
[^1]: It is not meiosis per se that is costly. As Williams realized, the cost stems from the reduction in relatedness between parent and outcrossed offspring. Indeed, in a later paper, Williams (1978) referred to the cost of meiosis as the "paradox of kin selection." Why should organisms invest resources in kin with a relatively low level of relatedness, $r$ (outcrossed progeny: $r = 0.5$), rather than in self-fertilized kin with a high level of relatedness ($r = 1$) (see Dagg 2016).

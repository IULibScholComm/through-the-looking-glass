...
|                           |              **Time 1**              |                                               **Time 2**                                              |
|:-------------------------:|:------------------------------------:|:-----------------------------------------------------------------------------------------------------:|
|   **Number of asexuals**  |                $N_{asex}$               |                                       $N_{asex}(S_{asex}B_{asex})$                                       |
|   **Number of sexuals**   |                $N_{sex}$                |                                     $rN_{sex}(S_{sex}B_{sex})$                                     |
| **Frequency of asexuals** |  $\frac{N_{asex}}{N_{asex} + N_{sex}}$  |  $\frac{N_{asex}(S_{asex}B_{asex})}{N_{asex}(S_{asex}B_{asex})+rN_{sex}(S_{sex}B_{sex})}$   |

...
par(new=TRUE) 
plot(time, outSex, type = "l", col = "red", ylim = c(0, 20000), xlab="Generation", ylab="Number")
legend(70, 17500, legend = c("Asexuals", "Sexuals"), col = c("blue", "red"), lty = 1)
```

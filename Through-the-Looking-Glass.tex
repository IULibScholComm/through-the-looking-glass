...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, breakable, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, arc=.35mm, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Box 1.1}, toprule=.15mm, opacityback=0, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, breakable, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, arc=.35mm, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, toprule=.15mm, opacityback=0, bottomtitle=1mm, colframe=quarto-callout-note-color-frame]

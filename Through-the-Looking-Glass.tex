...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, leftrule=.75mm, opacityback=0, titlerule=0mm, bottomtitle=1mm, toprule=.15mm, rightrule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, arc=.35mm, coltitle=black, left=2mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white]

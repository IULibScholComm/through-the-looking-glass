...
populations (C. M. Lively 1996). We thus seek a selective force that can
give an advantage to sexual reproduction on a very short time scale.
...
value.\footnote{Plasticity is more mainstream now than it was in the
  ...
  per se (see also C. M. Lively et al. 2000; Hazel, Smock, and Lively
  2004).} His model only assumes that sexual and asexual females have
equal fecundities and survivorship probabilities (see
...
uniparental progeny (C. M. Lively and Lloyd 1990). Roughly speaking, I
think we can adopt the following rules for the purpose of this book.
When considering the spread of a rare allele that induces
...
population (C. M. Lively 2009). \textbf{A} (top). Results for a 1:1 sex
ratio in the sexual population. Here the frequency of daughters produced
by sexual females was 1/2. The sexual population was initiated at
carrying capacity: \(K_{sex}\) = 10,000. A single parthenogenetic female
was introduced by the simulation at generation 1,000. Note that the
asexual lineage replaces the sexual population in about 25 generations,
and that it reaches a higher carrying capacity \(K_{asex}\) = 20,000.
\textbf{B} (bottom). Results for a female-biased sexual population. Here
the frequency of daughters produced by sexual females was 0.8. The
sexual population was initiated at carrying capacity: \(K_{sex}\) =
17,500. As above, a single parthenogenetic female was introduced into
the population at generation 1,000. Note that the asexual lineage
replaces the sexual population, but it takes longer. The simulation
assumes annual reproduction and non-overlapping generations. The R code
for the simulation, including interactive graphical output, can be found
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, left=2mm, toptitle=1mm, breakable, colback=white, coltitle=black, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Box 1.1}, bottomtitle=1mm, opacityback=0]
...
that it should not oftener occur.''\footnote{See also Elliott and Brook
  (Elliott and Brook 2007). They point out crucial differences between
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, left=2mm, toptitle=1mm, breakable, colback=white, coltitle=black, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, bottomtitle=1mm, opacityback=0]
...
parthenogenetic beetle) Maynard Smith (1978, 65) wrote, ``Further
...
arithmetic mean across years (review in Philippi and Seger 1989).
...
1975).\footnote{See also Elliott and Brook (Elliott and Brook 2007).
...
patches (Smith and Hoekstra 1980; C. M. Lively 1986a) (see also
...
then replace the sexual population (G. Bell 1982; Vrijenhoek and Parker
...
sexual population (Peters and Lively 1999, 2007; Schmid-Hempel and
Jokela 2002; Salathe et al. 2008). These related ideas are now called
the Red Queen Hypothesis (following G. Bell 1982).
...
asexual parasite with nine matching genotypes (C. M. Lively 2009). The
dashed line shows the average genotype frequency for hosts and
parasites.}
...
conceptual contributions by Glesener \& Tilman\footnote{\begin{quote}
  ...
  (Kelley, Antonovics, and Schmitt 1988; 1993; 1994).} (1978), and Lloyd
(1980). In particular, Lloyd writes, ``{[}B{]}iological interactions are
more likely than unpredictable physical conditions to provide the kind
of relentless, repetitive change that is necessary for sexual parents to
be selected because of the genetic diversity that sex engenders.''
...
selection against common host genotypes.\footnote{Using computer
  ...
  were solely responsible for the maintenance of diversity (Curtis M.
  Lively, Xu, and Ben-Ami 2021).}
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, left=2mm, toptitle=1mm, breakable, colback=white, coltitle=black, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2.1. Levene's model of multiple niche polymorphism.}, bottomtitle=1mm, opacityback=0]
...
(1986c).\footnote{Plasticity is more mainstream now than it was in the
  ...
  developmental strategy that is genetically determined, not the morph
  per se (see also C. M. Lively et al. 2000; Hazel, Smock, and Lively
  2004).} Hence, the two morphs are not different species, but rather
the result of phenotypic plasticity. In a blink of a field season, I
went from being a community ecologist to an evolutionary biologist.
...
slowly and was less fecund than the typical volcano-shaped morph (C. M.
...
animal taxa (G. Bell 1982). The data led him to reject the Lottery Model
...
together (Curtis M. Lively and Johnson 1994). Some \emph{P. antipodarum}
...
during heavy rains in the mountains (Winterbourn, Rounick, and Cowie
1981). Hence, under the Lottery Model, streams should have more sexual
females (and males) than lakes, because streams have more disturbance
and less competition (see Chapter~\ref{sec-eco-hyp} for a comparison of
models). By contrast, it seemed that competition for resources should be
greater in lakes than in streams. Indeed, lake populations of the snail
can be extremely dense. So, under the Tangled Bank, there should be more
sexual females in lakes, where competition for resources is expected to
be high. Finally, under the Red Queen Hypothesis, there should be more
...
(May and Anderson 1983). They showed that parasites had to kill infected
...
book, \emph{The Evolution of Sex}.\footnote{With respect to
  ...
  Smith (1978, 65) wrote, ``Further Investigations of these cases could
  be most interesting.'' When I met JMS, I did not know (or did not
...
\emph{per se} (C. M. Lively 1987). Hence, surprisingly, the results
favored the Red Queen Hypothesis. I presented these findings to a small
group at David Lloyd's flat, and they convinced me to submit to
\emph{Nature} (1987).\footnote{The group included Mark McKone. Mark was
  a post-doc with David, and his comments were especially influential.
...
priori} by Lloyd (1980) and others (e.g., Glesener and Tilman 1978; G.
Bell 1982). The Red Queen was supported by the data, but the data were
not used to generate the hypothesis. Using the same data to both
...
serious consideration.\footnote{I was also persuaded by elegant
  ...
  and Ellstrand 1984; Ellstrand and Antonovics 1985). Later studies
  showed that the rare advantage was likely due to escape from infection
  (Kelley, Antonovics, and Schmitt 1988; 1993; 1994).} For my own data,
I now asked whether the correlation between sex and infection was a
``red herring.'' In other words, could the correlation be generated
because of something else? Yes, it could. Here is how it might work.
First, infection could be higher in dense host populations as expected
under theory (Anderson and May 1979; May and Anderson 1979). Second,
there might be more sex in dense populations because asexual
reproduction is favored in sparse populations as a way for individuals
to ensure reproduction even in the absence of conspecific mates
(Tomlinson 1966; Gerritsen 1980; Lloyd 1980). This latter idea is called
the ``Reproductive Assurance Hypothesis.'' Hence, one could find a
positive correlation between sex and infection as a simple consequence
...
but there was no support for the Reproductive Assurance Hypothesis (C.
M. Lively 1992). Finally, the previously observed positive relationship
between sex and infection held (Figure~\ref{fig-3-5}).\footnote{The
  partial correlation between percent male and prevalence of infection,
  while controlling for habitat, is highly significant (\(r = 0.36\),
  \(P < 0.001\)). However, the partial correlation between percent male
  and habitat, while controlling for prevalence of infection, is
  marginally significant (\(r = 0.21\), \(P = 0.05\)). Similar results
  were gained after males were excluded from the calculation of
  infection prevalence, which controls for any sex-specific differences
  in susceptibility (as shown in Figure~\ref{fig-3-5}); specifically,
  prevalence of infection in females was significantly correlated with
  male frequency while controlling for habitat (\(r = 0.37\),
  \(P < 0.001\)), but the converse was not true (\(r = 0.19\),
  \(P = 0.06\)).} The Red Queen was still in the running.
...
stream populations (C. M. Lively 1987) plus two river samples. Gray
triangles represent lake populations (C. M. Lively 1987). Black
triangles represent lake and tarn populations (C. M. Lively 1992). The
...
estimate of the strength of parasite-mediated selection (C. M. Lively
2001). For example, infected snails might die at a faster rate than
uninfected snails because of the energetic demands of infection. In
addition, infected snails are more likely than uninfected snails to
forage after sunrise, which exposes them to predation by their final
hosts, ducks (Levri and Lively 1996; Levri and Fisher 2000). Prevalence
of infection might also fluctuate over time as the genetic diversity in
the host population changes and/or as the final hosts move among
locations. We now know that the prevalence of infection varies greatly
among years and among sites in the same lake (Gibson, Jokela, and Lively
2016). Thus, detecting a significant correlation between sex and
infection could be dicey, even if parasites were solely responsible for
the short-term maintenance of sex in mixed populations.\footnote{Using
  computer simulations, we recently found that detecting a significant
  positive correlation between clonal diversity and infection prevalence
  would only be expected in a fraction of parameter space, even when
  parasites were solely responsible for the maintenance of diversity
  (Curtis M. Lively, Xu, and Ben-Ami 2021).}
...
frequency (C. M. Lively and Jokela 2002). We then averaged the data for
each lake under the assumption that the averages would better represent
both the frequency of males and the prevalence of infection for each
lake. With these data, the correlation between male frequency and
infection prevalence was both positive and significant.\footnote{\(r = 0.47\);
...
a full understanding of the problem.\footnote{I think density dependence
  ...
  may also be density dependent (Curtis M. Lively et al. 1995; T. Bell,
  Freckleton, and Lewis 2006; C. M. Lively 2006). Habitat partitioning
  may also play a role in the distribution of sexual females among
  depth-stratified habitats (Negovetic and Jokela 2001).} But the
results do imply that the Red Queen Hypothesis was (and still is) worthy
of further study.
...
frequencies of males and females across all samples. (Redrawn from C. M.
Lively 1992.)}
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, left=2mm, toptitle=1mm, breakable, colback=white, coltitle=black, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 3.1.}, bottomtitle=1mm, opacityback=0]
...
genetic polymorphism are relatively narrow. Redrawn from (C. M. Lively
1999) assuming a small cost to plasticity.
...
Anderson, R. M., and R. M. May. 1979. {``Population Biology of
Infectious Diseases: Part 1.''} \emph{Nature} 280: 361--67.

\leavevmode\vadjust pre{\hypertarget{ref-antonovics1984a}{}}%
Antonovics, J., and N. C. Ellstrand. 1984. {``Experimental Studies of
the Evolutionary Significance of Sexual Reproduction. I. A Test of the
...
---------. n.d.b. {``Alice's Adventures in Algebra: Wonderland
Solved.''} \emph{New Scientist}.
...
---------. 1997. {``Life Before Model Systems: General Zoology at August
Weismann's Institute.''} \emph{American Zoologist} 37: 260--68.

\leavevmode\vadjust pre{\hypertarget{ref-clark1976a}{}}%
Clark, W. C. 1976. {``The Environment and the Genotype in
Polymorphism.''} \emph{Zoological Journal of the Linnean Society} 58:
255--62.
...
Elliott, L. P., and B. W. Brook. 2007. {``Revisiting Chamberlin:
Multiple Working Hypotheses for the 21st Century.''} \emph{Bioscience}
57: 608--14.

\leavevmode\vadjust pre{\hypertarget{ref-ellstrand1985a}{}}%
Ellstrand, N. C., and J. Antonovics. 1985. {``Experimental Studies of
the Evolutionary Significance of Sexual Reproduction II. A Test of the
Density-Dependent Selection Hypothesis.''} \emph{Evolution} 39: 657--66.
...
\emph{American Naturalist} 115: 718--42.
...
Gibson, A. K., J. Jokela, and C. M. Lively. 2016. {``Fine-Scale Spatial
...
Glesener, R. R., and D. Tilman. 1978. {``Sexuality and the Components of
Environmental Uncertainty: Clues from Geographical Parthenogenesis in
Terrestrial Animals.''} \emph{American Naturalist} 112: 659--73.
...
---------. 2001. \emph{Narrow Roads of Gene Land}. Vol. 2. Oxford
University Press.

\leavevmode\vadjust pre{\hypertarget{ref-hazel2004a}{}}%
Hazel, W., R. Smock, and C. M. Lively. 2004. {``The Ecological Genetics
of Conditional Strategies.''} \emph{American Naturalist} 163: 888--900.

\leavevmode\vadjust pre{\hypertarget{ref-jaenike1978a}{}}%
Jaenike, J. 1978. {``A Hypothesis to Account for the Maintenance of Sex
Within Populations.''} \emph{Evolutionary Theory} 3: 191--94.

\leavevmode\vadjust pre{\hypertarget{ref-kelley1993a}{}}%
Kelley, Steven E. 1993. {``Viruses and the Advantage of Sex in
Anthoxanthum Odoratum: A Review.''} \emph{Plant Species Biology} 8
(2-3): 217--23.
\url{https://doi.org/10.1111/j.1442-1984.1993.tb00072.x}.

\leavevmode\vadjust pre{\hypertarget{ref-kelley1988a}{}}%
Kelley, Steven E., J. Antonovics, and J. Schmitt. 1988. {``A Test of the
Short-Term Advantage of Sexual Reproduction.''} \emph{Nature} 331:
714--16.

\leavevmode\vadjust pre{\hypertarget{ref-kelley1994a}{}}%
Kelley, Steven E., J. Shykoff, William Donald Hamilton, and Jonathan
Charles Howard. 1994. {``Viral Pathogens and the Advantage of Sex in the
Perennial Grass \emph{Anthoxanthum Odoratum}.''} \emph{Philosophical
Transactions of the Royal Society of London. Series B: Biological
Sciences} 346 (1317): 295--302.
\url{https://doi.org/10.1098/rstb.1994.0146}.

\leavevmode\vadjust pre{\hypertarget{ref-kondrashov1993a}{}}%
Kondrashov, A. S. 1993. {``Classification of Hypotheses on the Advantage
of Amphimixis.''} \emph{Journal of Heredity} 84: 372--87.
...
Niche Is Available.''} \emph{American Naturalist} 87: 331--33.

\leavevmode\vadjust pre{\hypertarget{ref-levin1975a}{}}%
Levin, D. A. 1975. {``Pest Pressure and Recombination Systems in
Plants.''} \emph{American Naturalist} 109: 437--51.

\leavevmode\vadjust pre{\hypertarget{ref-levins1966a}{}}%
Levins, R. 1966. {``The Strategy of Model Building in Population
Biology.''} \emph{American Scientist} 54: 421--31.
...
Levri, E. P., and L. M. Fisher. 2000. {``The Effect of a Trematode
Parasite (Microphallus Sp.) on the Response of the Freshwater Snail
\emph{Potamopyrgus Antipodarum} to Light and Gravity.''}
\emph{Behaviour} 137 (9): 1141--51.
\url{https://doi.org/10.1163/156853900502565}.

\leavevmode\vadjust pre{\hypertarget{ref-levri1996a}{}}%
Levri, E. P., and C. M. Lively. 1996. {``The Effects of Size,
Reproductive Condition, and Parasitism on Foraging Behaviour in a
Freshwater Snail, \emph{Potamopyrgus Antipodarum}.''} \emph{Animal
...
Lively, C. M. 1986a. {``Canalization Versus Developmental Conversion in
a Spatially Variable Environment.''} \emph{American Naturalist} 128:
561--72.

\leavevmode\vadjust pre{\hypertarget{ref-lively1986b}{}}%
---------. 1986b. {``Competition, Comparative Life Histories, and
Maintenance of Shell Dimorphism in a Barnacle.''} \emph{Ecology} 67:
858--64.

\leavevmode\vadjust pre{\hypertarget{ref-lively1986c}{}}%
---------. 1986c. {``Predator-Induced Shell Dimorphism in the Acorn
Barnacle Chthamalus Anisopoma.''} \emph{Evolution} 40: 232--42.
\url{https://doi.org/10.1111/j.1558-5646.1986.tb00466.x}.

\leavevmode\vadjust pre{\hypertarget{ref-lively1987a}{}}%
---------. 1987. {``Evidence from a New Zealand Snail for the
Maintenance of Sex by Parasitism.''} \emph{Nature} 328: 519--21.

\leavevmode\vadjust pre{\hypertarget{ref-lively1992a}{}}%
---------. 1992. {``Parthenogenesis in a Freshwater Snail: Reproductive
Assurance Versus Parasitic Release.''} \emph{Evolution} 46: 907--13.

\leavevmode\vadjust pre{\hypertarget{ref-lively1996a}{}}%
---------. 1996. {``Host-Parasite Coevolution and Sex.''}
\emph{Bioscience} 46: 107--9.

\leavevmode\vadjust pre{\hypertarget{ref-lively1999b}{}}%
---------. 1999. {``Developmental Strategies in Spatially Variable
...
edited by R. Tollrian and C. D. Harvell, 245--58. Princeton University
Press.

\leavevmode\vadjust pre{\hypertarget{ref-lively2001a}{}}%
---------. 2001. {``Trematode Infection and the Distribution and
Dynamics of Parthenogenetic Snail Populations.''} \emph{Parasitology}
123: S19--26.

\leavevmode\vadjust pre{\hypertarget{ref-lively2006a}{}}%
---------. 2006. {``The Ecology of Virulence.''} \emph{Ecology Letters}
9: 1089--95.
...
Intertidal Barnacle.''} \emph{Ecology} 81: 1240--47.

\leavevmode\vadjust pre{\hypertarget{ref-lively2002a}{}}%
Lively, C. M., and J. Jokela. 2002. {``Temporal and Spatial
Distributions of Parasites and Sex in a Freshwater Snail.''}
\emph{Evolutionary Ecology Research} 4: 219--26.
...
Lively, Curtis M., and Steven G. Johnson. 1994. {``Brooding and the
Evolution of Parthenogenesis: Strategy Models and Evidence from Aquatic
Invertebrates.''} In \emph{Proceedings of the Royal Society of London.
Series B: Biological Sciences}, 256:89--95. 1345.
\url{https://doi.org/10.1098/rspb.1994.0054}.

\leavevmode\vadjust pre{\hypertarget{ref-lively1995a}{}}%
Lively, Curtis M., Steven G. Johnson, Lynda F. Delph, and Keith Clay.
1995. {``Thinning Reduces the Effect of Rust Infection on Jewelweed
(Impatiens Capensis).''} \emph{Ecology} 76 (6): 1859--62.
\url{https://doi.org/10.2307/1940718}.

\leavevmode\vadjust pre{\hypertarget{ref-lively2021a}{}}%
Lively, Curtis M., Julie Xu, and Frida Ben-Ami. 2021. {``Causation
Without Correlation: Parasite-Mediated Frequency-Dependent Selection and
Infection Prevalence.''} \emph{Biology Letters} 17 (12): 20210321.
...
---------. 1984. {``Variation Strategies of Plants in Hererogeneous
...
Infectious Diseases: Part II.''} \emph{Nature} 280: 455--61.

\leavevmode\vadjust pre{\hypertarget{ref-may1983a}{}}%
---------. 1983. {``Epidemiology and Genetics in the Coevolution of
Parasites and Hosts.''} In \emph{Proceedings of the Royal Society of
London b, Biological Sciences}, 219:281--313.
...
Freshwater Snail.''} \emph{Ecology} 82: 2805--15.
...
Peters, A. D., and C. M. Lively. 1999. {``The Red Queen and Fluctuating
...
---------. 2007. {``Short- and Long-Term Benefits and Detriments to
Recombination Under Antagonistic Coevolution.''} \emph{Journal of
Evolutionary Biology} 20: 1206--17.
...
Phillips, Ngaire R., and David M. Lambert. 1990. {``A Cladistic Analysis
of Species of the Molluscan Genus \emph{Potamopyrgus} Based on Allozyme
Data.''} \emph{New Zealand Journal of Zoology} 17 (2): 257--63.
\url{https://doi.org/10.1080/03014223.1990.10422600}.

\leavevmode\vadjust pre{\hypertarget{ref-platt1964a}{}}%
Platt, J. R. 1964. {``Strong Inference.''} \emph{Science} 146: 347--53.

\leavevmode\vadjust pre{\hypertarget{ref-popper1959a}{}}%
Popper, K. 1959. \emph{The Logic of Scientific Discovery}. London:
Hutchinson \& Company.

\leavevmode\vadjust pre{\hypertarget{ref-prout1968a}{}}%
Prout, T. 1968. {``Sufficient Conditions for Multiple Niche
Polymorphism.''} \emph{American Naturalist}.

\leavevmode\vadjust pre{\hypertarget{ref-salathe2008a}{}}%
Salathe, M., R. D. Kouyos, R. R. Regoes, and S. Bonhoeffer. 2008.
{``Rapid Parasite Adaptation Drives Selection for High Recombination
Rates.''} \emph{Evolution} 62: 295--300.

\leavevmode\vadjust pre{\hypertarget{ref-schmid-hempel2002a}{}}%
Schmid-Hempel, P., and J. Jokela. 2002. {``Socially Structured
Populations and Evolution of Recombination Under Antagonistic
Coevolution.''} \emph{American Naturalist} 160: 403--8.
...
Smith, J. Maynard, and R. Hoekstra. 1980. {``Polymorphism in a Varied
Environment: How Robust Are the Models?''} \emph{Genetics Research} 35
(1): 45--57. \url{https://doi.org/10.1017/S0016672300013926}.

\leavevmode\vadjust pre{\hypertarget{ref-soper2013a}{}}%
Soper, D. M., M. Neiman, O. P. Savytskyy, M. E. Zolan, and C. M. Lively.
...
Coexistence.''} \emph{American Zoologist} 19: 787--97.

\leavevmode\vadjust pre{\hypertarget{ref-vrijenhoek1998a}{}}%
---------. 1998. {``Animal Clones and Diversity.''} \emph{Bioscience}
48: 617--28.

\leavevmode\vadjust pre{\hypertarget{ref-vrijenhoek2009a}{}}%
Vrijenhoek, R. C., and E. D. Parker. 2009. {``Geographical
Parthenogenesis: General Purpose Genotypes and Frozen Niche
Variation.''} In \emph{Lost Sex: The Evolutionary Biology of
Parthenogenesis}, edited by I. Schön, K. Martens, and P. Dijk, 99--131.
London: Springer.

\leavevmode\vadjust pre{\hypertarget{ref-wallace1975a}{}}%
Wallace, B. 1975. {``Hard and Soft Selection Revisited.''}
\emph{Evolution} 29: 465--73.
...
\emph{Potamopyrgus} (Gastropoda: Hydrobiidae).''} \emph{Malacologia} 10:
283--321.

\leavevmode\vadjust pre{\hypertarget{ref-winterbourn1973a}{}}%
---------. 1973. {``Larval Trematoda Parasitizing the New Zealand
Species of \emph{Potamopyrgus} (Gastropoda: Hydrobiidae).''} \emph{Mauri
Ora} 2: 17--30.

\leavevmode\vadjust pre{\hypertarget{ref-winterbourn1981a}{}}%
Winterbourn, M. J., J. S. Rounick, and B. Cowie. 1981. {``Are New
Zealand Stream Ecosystems Really Different?''} \emph{New Zealand Journal
of Marine and Freshwater Research} 15: 321--28.

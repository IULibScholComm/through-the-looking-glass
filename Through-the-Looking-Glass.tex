...
\protect\hyperlink{callout-1}{Box 1.1} for condensed definitions.)
...
fixation, barring severe inbreeding depression (Fisher 1941). So, why
...
\label{fig-clonal}Clonal invasion dynamics. Results from a simulation
study in which a single clonal individual was introduced into a sexual
...
The interactive graph can also be run \href{}{here} for users without R.
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomrule=.15mm, left=2mm, titlerule=0mm, rightrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Box 1.1}, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, coltitle=black]
...
have higher carrying capacities, as shown in (Figure~\ref{fig-clonal}).
...
for example, the following statement by Rudolf Wagner in his 1857 review
of von Siebold's book on parthenogenesis {[}as translated from the
original German by Churchill (1979){]}:
...
is that it should not oftener occur}.\footnote{I suspect that Darwin
  used the phrase ``no longer wonderful'' to mean ``no longer
  astonishing.'' See
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomrule=.15mm, left=2mm, titlerule=0mm, rightrule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, coltitle=black]

...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, colback=white, opacityback=0, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Box 1.1}, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, rightrule=.15mm, left=2mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, colback=white, opacityback=0, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, rightrule=.15mm, left=2mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6]

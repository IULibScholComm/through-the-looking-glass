...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, enhanced, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, sharp corners, frame hidden, breakable]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, toprule=.15mm, opacityback=0, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Box 1.1}, breakable, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, colback=white, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, toprule=.15mm, opacityback=0, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, breakable, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, colback=white, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, arc=.35mm, leftrule=.75mm]

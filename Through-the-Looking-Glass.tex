...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, leftrule=.75mm, left=2mm, bottomtitle=1mm, coltitle=black, colback=white, breakable, toptitle=1mm, toprule=.15mm, titlerule=0mm, rightrule=.15mm, arc=.35mm, opacityback=0, bottomrule=.15mm, colframe=quarto-callout-note-color-frame]

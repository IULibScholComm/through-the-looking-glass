...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, rightrule=.15mm, breakable, opacityback=0, left=2mm, titlerule=0mm, toprule=.15mm, bottomtitle=1mm, colback=white, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, coltitle=black, bottomrule=.15mm]

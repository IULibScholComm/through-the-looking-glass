...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, coltitle=black, breakable, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Box 1.1}, leftrule=.75mm, toprule=.15mm, left=2mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, coltitle=black, breakable, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, rightrule=.15mm, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, leftrule=.75mm, toprule=.15mm, left=2mm, colback=white]

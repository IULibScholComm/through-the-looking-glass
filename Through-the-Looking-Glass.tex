...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Box 1.1}, colframe=quarto-callout-tip-color-frame, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, bottomtitle=1mm, rightrule=.15mm, toptitle=1mm, titlerule=0mm, arc=.35mm, breakable, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1.2}, colframe=quarto-callout-note-color-frame, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, bottomtitle=1mm, rightrule=.15mm, toptitle=1mm, titlerule=0mm, arc=.35mm, breakable, coltitle=black]

...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, left=2mm, coltitle=black, arc=.35mm, breakable, bottomtitle=1mm, bottomrule=.15mm, toprule=.15mm, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Box 1.1}, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, toptitle=1mm, opacityback=0, leftrule=.75mm]
...
males.\footnote{I used slightly different variable names, and I tried to

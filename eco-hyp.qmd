...
::: {.callout-note #callout-3}
## Box 2.1. Levene's model of multiple niche polymorphism. {#callout-3}
...
![](images/fig2-5.jpg){fig-alt="" width=65% fig-align="center" fig-scap="Prout's model of dominance"} 

<!--The papers by Levene (1953) and Prout (1968) helped to lay the foundation for the fusion of population genetics and population ecology.-->
:::
